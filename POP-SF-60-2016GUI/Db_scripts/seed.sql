...
INSERT INTO Namjestaj(TipNamjestajaID, Naziv, Sifra, Cijena, Kolicina, Obrisan) 
VALUES (1, 'Ultra polica', 'UL1PO', 123, 2, 0);
INSERT INTO Namjestaj(TipNamjestajaID, Naziv, Sifra, Cijena, Kolicina, Obrisan) 
VALUES (2, 'Bijeli regal', 'BR1RE', 125, 5, 0);
INSERT INTO Namjestaj(TipNamjestajaID, Naziv, Sifra, Cijena, Kolicina, Obrisan) 
VALUES (3, 'Crna ugaona', 'CR1UG', 500, 10, 0);
